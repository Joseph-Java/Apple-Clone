...
export default function Navbar({mode}) {
  ...
  const menuData = {
    Mac: {
      sections: [
        ...
        {
          title: "More From Mac",
          links: [{ label: "Mac Support", size: "small" }],
        },
      ],
    },
    Ipad: {
      sections: [
        ...
        },
        {
          ...
          links: [{ label: "iPad Support", size: "small" }],
        },
      ],
    },
    Iphone: {
      sections: [
        ...
        },
        {
          ...
          links: [{ label: "iPhone Support", size: "small" }],
        },
      ],
    },
    Support: {
  ...
  return (
    <div className="">
      {/* HEADER */}
      <header className={`w-full h-12 fixed top-0 left-0 right-0 z-60 ${mode === "fixed" ? "fixed" : "sticky"} bg-zinc-950 backdrop-blur-md  flex items-center justify-between px-4`}>
                ...
                >
                  ...
                  {activeMenu === menu && (
                    <div
                      ...
                      className="fixed left-0 top-12 w-full h-[75vh] bg-black backdrop-blur-2xl z-40 overflow-y-scroll pb-6"
                    >
                          ...
                          <div key={i}>
                            ...
                            <ul className="space-y-2 text-white">
                              {section.links.map((link, index) => (
                                <li
                                  key={index}
                                  className={` font-semibold cursor-pointer ${link.size === "small" ? "text-xs" : "text-xl"}`}
                                >

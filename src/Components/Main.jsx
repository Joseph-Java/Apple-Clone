...
import desktopIcon2 from "./../assets/hero_main_image.png";
import mobileIcon2 from "./../assets/mobile icon.png";

function Main() {
  return (
    <div>
      {/* HERO */}
            <div className="bg-black black w-full pt-16">
            <Link to={"/iPhone-17-pro"} className="pt-20">
              ...
              <div className="mt-16">
                <picture>
                  <source media="(min-width: 768px)" srcSet={desktopIcon2} />
                  <img src={mobileIcon2} alt="Hero" className="w-full max-w-5xl mx-auto object-cover" />
                </picture>
              </div>
            </Link>
            </div>
      ...
      <section className="bg-gray-100 mt-3 w-full">
        <div className="text-center pt-12 w-full">
          <h1 className="font-semibold text-3xl md:text-6xl mb-1">
            {" "}
            iPhone Air{" "}
          </h1>
        ...
        <div className="p-4 py-10">
          <picture>
            ...
            <img
              src={mobileIcon}
              alt="iPhone Air"
              className="max-w-xs md:max-w-5xl w-full mx-auto object-cover "
            />
          </picture>
        </div>
      </section>
      ...
      <section className="bg-gray-100 mt-3 w-full">
        ...
        <div className="p-4 py-10">
          <picture>
            <source
              media="(min-width: 768px)"
              srcSet={iphone17Desktop}
              className="w-full h-full max-w-4xl"
            />
            <img
              src={iphone17Mobile}
              alt="iPhone 17"
              className="max-w-xs md:max-w-3xl w-full mx-auto object-cover"
            />
          </picture>
        </div>
      </section>
      ...
      <div className="flex flex-col md:flex-row gap-3 mt-3 w-full px-0 md:px-4">
        <section className="bg-black w-full md:max-w-2xl">
          <div className="text-center pt-12 w-full text-white mb-4">
            ...
            <button className="mt-5 bg-blue-700 text-white text-xl md:text-xl px-5 py-2 rounded-full outline-none hover:bg-blue-500 transition-all cursor-pointer">
              {" "}
              Learn more
            </button>
          </div>
        ...
        <section className="bg-black w-full md:max-w-2xl">
          <div className="text-center pt-12 w-full text-white mb-4 ">
            ...
            <p className="text-base sm:text-lg md:text-[22px] max-w-50 sm:max-w-80 md:max-w-105 mx-auto">
              {" "}
          ...
          <div>
            <img
              src={ipadPro}
              alt="iPad Pro"
              className="w-full max-w-80 md:max-w-100 mx-auto object-cover"
            />
          </div>
        </section>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-3 mt-3 w-full px-0 md:px-4">
        <section className="bg-gray-100 w-full pb-8 md:max-w-2xl">
          <div className="text-center pt-12 w-full mb-4">
            ...
            <p className="text-base sm:text-lg md:text-[20px] max-w-50 sm:max-w-80 md:max-w-105 mx-auto ">
              {" "}
              Now with the speed of the A16 chip and double the starting
              storage{" "}
            </p>
            <button className="mt-5 bg-blue-700 text-white text-xl md:text-xl px-5 py-2 rounded-full outline-none hover:bg-blue-500 transition-all cursor-pointer">
              {" "}
        ...
        <section className="bg-gradient-to-b from-sky-200 via-sky-90 to-white w-full md:max-w-2xl">
          ...
          <div className="mt-10">
            <img
              src={macBookAir}
              alt="MacBook Air"
              className="w-full max-w-80 md:max-w-120 mx-auto object-cover"
            />
          </div>
        </section>
      </div>
